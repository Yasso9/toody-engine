...
namespace input
{
    struct S_KeyboardMove
    {
        ...
        constexpr S_KeyboardMove( sf::Keyboard::Key aUp,
    ...
    constexpr S_KeyboardMove ZDSQ { sf::Keyboard::Z, sf::Keyboard::D,
                                    sf::Keyboard::S, sf::Keyboard::Q };
    constexpr S_KeyboardMove ILKJ { sf::Keyboard::I, sf::Keyboard::L,
