...
sf::Vector2f to_view(sf::Vector2f const & positionInLastView, sf::View const & lastView, sf::View const & newView)
{
    /* positionInLastView -> convertion dans la nouvelle vue -> positionInNewView 
    -> rajout du départ de la nouvelle vue par rapport à l'ancienne -> positionFinish */
