...
bool is_in_part( sf::Vector2f const value,
...
void set_quad_position( sf::Vertex *& quad,
                        ...
                        sf::Vector2u const & tilePosition )
{
    ...
    quad[0].position =
        sf::Vector2f( basePosition.x + tilePositionFloat.x * g_squareSize,
                      basePosition.y + tilePositionFloat.y * g_squareSize );
    quad[1].position =
        sf::Vector2f( basePosition.x + ( tilePositionFloat.x + 1.f ) * g_squareSize,
                      basePosition.y + tilePositionFloat.y * g_squareSize );
...
void set_quad_texture_coordinate( sf::Vertex *& quad,
                                  sf::Vector2u const & tilePosition )
{
    // TYPO avoir directement un sf::Vector2f
    sf::Vector2f const tilePositionFloat { static_cast<sf::Vector2f>(
    ...
    quad[0].texCoords = sf::Vector2f( tilePositionFloat.x * g_squareSize,
                                      tilePositionFloat.y * g_squareSize );
    quad[1].texCoords = sf::Vector2f( ( tilePositionFloat.x + 1.f ) * g_squareSize,
                                      tilePositionFloat.y * g_squareSize );
    quad[2].texCoords = sf::Vector2f( ( tilePositionFloat.x + 1.f ) * g_squareSize,
                                      ( tilePositionFloat.y + 1.f ) * g_squareSize );
    quad[3].texCoords = sf::Vector2f( tilePositionFloat.x * g_squareSize,
                                      ( tilePositionFloat.y + 1.f ) * g_squareSize );
}
