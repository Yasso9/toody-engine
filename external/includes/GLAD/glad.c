/*
    ...
    OpenGL loader generated by glad 0.1.35 on Wed Apr  6 17:27:50 2022.
...
static int get_exts( void )
{
    ...
    else
    {
        ...
        {
            exts_i =
                ( char ** )malloc( ( size_t )num_exts_i * ( sizeof *exts_i ) );
        }
...
static void load_GL_VERSION_1_0( GLADloadproc load )
{
    ...
    glad_glPolygonStipple =
        ( PFNGLPOLYGONSTIPPLEPROC )load( "glPolygonStipple" );
    ...
    glad_glPixelTransferf =
        ( PFNGLPIXELTRANSFERFPROC )load( "glPixelTransferf" );
    glad_glPixelTransferi =
        ( PFNGLPIXELTRANSFERIPROC )load( "glPixelTransferi" );
    ...
    glad_glGetPixelMapuiv =
        ( PFNGLGETPIXELMAPUIVPROC )load( "glGetPixelMapuiv" );
    glad_glGetPixelMapusv =
        ( PFNGLGETPIXELMAPUSVPROC )load( "glGetPixelMapusv" );
...
static void load_GL_VERSION_4_0( GLADloadproc load )
{
    ...
    glad_glBlendEquationi =
        ( PFNGLBLENDEQUATIONIPROC )load( "glBlendEquationi" );
...
static void load_GL_VERSION_4_1( GLADloadproc load )
{
    ...
    glad_glViewportArrayv =
        ( PFNGLVIEWPORTARRAYVPROC )load( "glViewportArrayv" );
    ...
    glad_glScissorIndexed =
        ( PFNGLSCISSORINDEXEDPROC )load( "glScissorIndexed" );
...
static void load_GL_VERSION_4_3( GLADloadproc load )
{
    ...
    glad_glTexBufferRange =
        ( PFNGLTEXBUFFERRANGEPROC )load( "glTexBufferRange" );
    ...
    glad_glPushDebugGroup =
        ( PFNGLPUSHDEBUGGROUPPROC )load( "glPushDebugGroup" );
    glad_glPopDebugGroup = ( PFNGLPOPDEBUGGROUPPROC )load( "glPopDebugGroup" );
    glad_glObjectLabel   = ( PFNGLOBJECTLABELPROC )load( "glObjectLabel" );
    glad_glGetObjectLabel =
        ( PFNGLGETOBJECTLABELPROC )load( "glGetObjectLabel" );
    glad_glObjectPtrLabel =
        ( PFNGLOBJECTPTRLABELPROC )load( "glObjectPtrLabel" );
...
static void load_GL_VERSION_4_5( GLADloadproc load )
{
    ...
    glad_glMapNamedBuffer =
        ( PFNGLMAPNAMEDBUFFERPROC )load( "glMapNamedBuffer" );
    ...
    glad_glCreateTextures =
        ( PFNGLCREATETEXTURESPROC )load( "glCreateTextures" );
    ...
    glad_glCreateSamplers =
        ( PFNGLCREATESAMPLERSPROC )load( "glCreateSamplers" );
    ...
    glad_glGetnUniformuiv =
        ( PFNGLGETNUNIFORMUIVPROC )load( "glGetnUniformuiv" );
    ...
    glad_glGetnPixelMapfv =
        ( PFNGLGETNPIXELMAPFVPROC )load( "glGetnPixelMapfv" );
    ...
    glad_glGetnColorTable =
        ( PFNGLGETNCOLORTABLEPROC )load( "glGetnColorTable" );
    ...
    glad_glTextureBarrier =
        ( PFNGLTEXTUREBARRIERPROC )load( "glTextureBarrier" );
}
...
static void find_coreGL( void )
{
    ...
    const char * version;
    const char * prefixes[] = { "OpenGL ES-CM ",
                                "OpenGL ES-CL ",
                                "OpenGL ES ",
                                NULL };
